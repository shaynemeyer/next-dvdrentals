...
function EditForm({
  ...
  const [isActive, setIsActive] = useState(Boolean(customer.active));
  const initialState = { message: '', errors: {} };
  const updateCustomerWithId = updateCustomer.bind(null, customer.customer_id!);
      ...
      <div className="mb-4 w-[380px]">
        ...
        <div className="relative">
          <select
            ...
            defaultValue={customer.address_id}
