import { deleteInventory } from '@/lib/actions/inventory';
...
export function UpdateInventory({ inventory_id }: { inventory_id: string }) {
  return (
    <Link
      href={`/inventory/${inventory_id}/edit`}
...
export function DeleteInventory({ inventory_id }: { inventory_id: string }) {
  const deleteInventoryWithId = deleteInventory.bind(null, inventory_id);
